  ...
  return (
    <section className='p-4 max-w-md mx-auto'>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <div>
          <button
            className='border-2 border-black py-1 px-2 my-2 rounded'
            type='submit'
          >
            REGISTRARSE
          </button>
